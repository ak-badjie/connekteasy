...
import { Users, CalendarRange, BookOpen, BookMarked, Briefcase, ArrowRight } from "lucide-react";

export default function AdminOverview() {
  const [counts, setCounts] = useState({ users: 0, events: 0, courses: 0, resources: 0, jobs: 0 });
  ...
  return (
    <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="max-w-6xl mx-auto space-y-6">
      ...
      <motion.div variants={staggerItem} className="grid grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4">
